...
export const COSTUME_STYLES: CostumeStyle[] = [
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Eternal (Vampire).svg',
    hexColor: '#8a0303',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Rotted (Zombie).svg',
    hexColor: '#4a5e2a',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/Coven Leader (Witch).svg',
    hexColor: '#5c0099',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/Grim Reaper (Skeleton).svg',
    hexColor: '#a3a3a3',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/Harvest Curse (Pumpkin).svg',
    hexColor: '#cf5700',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/Possessed (Demon).svg',
    hexColor: '#3d0000',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Mooncursed (Werewolf).svg',
    hexColor: '#5e4b35',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Apparition (Ghost).svg',
    hexColor: '#a5f2f3',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Jester (Clown).svg',
    hexColor: '#ff0055',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Marionette (Doll).svg',
    hexColor: '#fcede6',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Visitor (Alien).svg',
    hexColor: '#39ff14',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Construct (Cyborg).svg',
    hexColor: '#00e1ff',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Preserved (Mummy).svg',
    hexColor: '#e3cfa0',
  ...
  },
  {
    ...
    icon: '/Icons/ORIGINAL NIGHTMARES/The Strawman (Scarecrow).svg',
    hexColor: '#d6ae5c',
  ...
  },
  {
    ...
    icon: '/Icons/SUPERNATURAL/Dean Winchester (The Righteous Man).svg',
    hexColor: '#4a5d23',
  ...
  },
  {
    ...
    icon: '/Icons/SUPERNATURAL/Sam Winchester (The Boy King).svg',
    hexColor: '#3b3f4f',
  ...
  },
  {
    ...
    icon: '/Icons/SUPERNATURAL/Castiel (The Fallen Angel).svg',
    hexColor: '#c2b280',
  ...
  },
  {
    ...
    icon: '/Icons/SUPERNATURAL/Crowley (King of the Crossroads).svg',
    hexColor: '#8b0000',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Dr. Doom (The Monarch).svg',
    hexColor: '#3d553d',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Kratos (Ghost of Sparta).svg',
    hexColor: '#b5a6a0',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Master Chief (The Spartan).svg',
    hexColor: '#2e4530',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Lara Croft (The Survivor).svg',
    hexColor: '#8b7355',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Lich King (Lord of the Scourge).svg',
    hexColor: '#36454f',
  ...
  },
  {
    ...
    icon: '/Icons/VIDEO GAME LEGENDS/Geralt (The White Wolf).svg',
    hexColor: '#c0c0c0',
    accentColorClass: 'text-gray-400',
    gender: 'male',
    category: 'game'
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/Darth Vader (The Dark Lord).svg',
    hexColor: '#ff0000',
  ...
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/Terminator (The Cyborg Assassin).svg',
    hexColor: '#808080',
  ...
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/John Wick (The Boogeyman).svg',
    hexColor: '#2b2b2b',
  ...
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/Joker (Agent of Chaos).svg',
    hexColor: '#5a00b3',
  ...
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/Predator (The Hunter).svg',
    hexColor: '#a9a9a9',
    accentColorClass: 'text-gray-400',
    gender: 'unisex',
    category: 'movie'
  },
  {
    ...
    icon: '/Icons/MOVIE MANIACS/Mad Max (The Road Warrior).svg',
    hexColor: '#964b00',
